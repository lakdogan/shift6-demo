**free
      ...
      dcl-proc Main;
        ...
        msg = 'User=' + %trim(user) + ';Action=' + %trim(action)
            + ';Status=' + %trim(status) + ';Timestamp='
            + %char(%timestamp())
            + ';Details=' + 'This line starts with plus and should '
            + 'align with the previous plus operator'
            + ';More=' + 'Readable plus continuations matter for RPG '
            + 'Free maintenance';
